...
update BASEBALL set DISTRIBUIDOR_ID= 1 where ID in (1,2,7);
update BASEBALL set DISTRIBUIDOR_ID= 2 where ID in (3,5);
update BASEBALL set DISTRIBUIDOR_ID= 4 where ID in (4);
update BASEBALL set DISTRIBUIDOR_ID= 5 where ID in (6);
update BASEBALL set DISTRIBUIDOR_ID= 6 where ID in (8);

alter table DISTRIBUIDOR_ID
